...
class Preprocessor(object):
    ...
    def load_data_from_pickle(
        ...
        """load pandas data and extract row[label],row[code] to a CSR label matrix and a list of text strings.
        ...
        Args:
            ...
            has_rel (bool  optional): if True, it contains label relevance,Default: False.
